  ...
  Widget build(BuildContext context) {
    ...
    return DSSidebarSection(
      ...
      header: EmojiLabelEditorPopup(
        ...
        label: label,
        child: LayoutBuilder(
          builder: (context, constraints) => DSSidebarSectionHeader(
            background: background,
            pinned: pinned.value,
            title: PortalTarget(
              anchor: switch (constraints.maxWidth <= mobileBreakpoint) {
                true => const Aligned(
                ...
                child: VBox(
                  style: Style(
                    ...
                    switch (constraints.maxWidth <= mobileBreakpoint) {
                      true => $box.margin.vertical.ref(SpaceVariant.small),
                      false => $box.margin.horizontal.ref(SpaceVariant.medium),
                    },
                    $box.border.all(
                      width: 1,
