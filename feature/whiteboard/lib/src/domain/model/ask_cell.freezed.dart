...
mixin _$AskCellId {
  ...
  /// Serializes this AskCellId to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AskCellId
...
mixin _$AskCellParentId {
  ...
  /// Serializes this AskCellParentId to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AskCellParentId
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class $AskCellParentIdCopyWith<$Res> {
  ...
  @useResult
  $Res call({String FolderId, String whiteboardId});
}
...
class _$AskCellParentIdImpl implements _AskCellParentId {
  const _$AskCellParentIdImpl(
      {required this.FolderId, required this.whiteboardId});
  ...
  @override
  String toString() {
    return 'AskCellParentId(FolderId: $FolderId, whiteboardId: $whiteboardId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, FolderId, whiteboardId);
...
abstract class _AskCellParentId implements AskCellParentId {
  const factory _AskCellParentId(
      ...
      required final String whiteboardId}) = _$AskCellParentIdImpl;
...
mixin _$AskCell {
  ...
  /// Serializes this AskCell to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AskCell
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
