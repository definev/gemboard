...
mixin _$AskIOId {
  ...
  /// Serializes this AskIOId to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AskIOId
...
mixin _$AskIOParentId {
  ...
  /// Serializes this AskIOParentId to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AskIOParentId
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class $AskIOParentIdCopyWith<$Res> {
  ...
  @useResult
  $Res call({String FolderId, String whiteboardId, String askCellId});
}
...
class _$AskIOParentIdImpl implements _AskIOParentId {
  ...
  @override
  String toString() {
    return 'AskIOParentId(FolderId: $FolderId, whiteboardId: $whiteboardId, askCellId: $askCellId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, FolderId, whiteboardId, askCellId);
